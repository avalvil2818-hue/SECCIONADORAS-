...
def inicio():
    ...
    for valvula, coords in posiciones.items():
        ...
        if estados[valvula] == "Abierta":
            ...
            color = None
        if color:
            overlays += f'<a href="/{valvula}" title="Válvula {valvula.upper()}" style="position:absolute; left:{x1}px; top:{y1}px; width:{x2-x1}px; height:{y2-y1}px; background:{color}; border-radius:5px;"></a>'
    ...
    <head>
        ...
        <style> 
            ...
            .imagen-dti {{ display:block; background:white; opacity:0.85; max-width:100%; height:auto; }}
            footer {{ background:#fbc02d; color:black; padding:10px; position:relative; bottom:0; width:100%; text-align:center; }}
    ...
    <header>
        ...
        <main>
            <div class="contenedor">
                ...
                {overlays}
                <map name="mapa">
                    <area alt="Torre de enfriamiento norte" title="Torre de enfriamiento norte" href="" coords="405,260,485,341" shape="rect">
                    <area alt="Torre de enfriamiento sur" title="Torre de enfriamiento sur" href="" coords="401,383,491,465" shape="rect">
                    <area alt="Llenaderas" title="Llenaderas" href="" coords="825,375,961,425" shape="rect">
                    <area alt="Caldera 3" title="Caldera 3" href="" coords="846,271,924,333" shape="rect">
                    <area alt="PTA" title="PTA" href="" coords="235,488,289,539" shape="rect">
                    <area alt="Caldera 1" title="Caldera 1" href="" coords="285,358,328,394" shape="rect">
                    <area alt="Caldera 2" title="Caldera 2" href="" coords="287,415,327,447" shape="rect">
                    <area alt="Urea 1" title="Urea 1" href="" coords="240,131,276,268" shape="rect">
                    <area alt="Urea 2" title="Urea 2" href="" coords="835,52,871,128" shape="rect">
                    <area alt="Dirección" title="Dirección" href="" coords="454,120,657,173" shape="rect">
                </map>
            </div>
